...
!function() {
    ...
    const z = e=>e && "a" === e.nodeName.toLowerCase()
      ...
      , X = (e,t)=>(t = t || e.selection.getNode(),
    te(t) ? e.dom.select("a[href]", t)[0] : e.dom.getParent(t, "a[href]"))
      , Y = (e,t)=>(t ? t.innerText || t.textContent : e.getContent({
        format: "text"
    })).replace(/\uFEFF/g, "")
      , Z = e=>R.grep(e, G).length > 0
      , ee = e=>{
        const t = e.schema.getTextInlineElements();
        return 0 === H(e.selection.getRng(), (e=>1 === e.nodeType && !z(e) && !F(t, e.nodeName.toLowerCase()))).length
    }
      ...
      , ne = (e,t,n)=>{
        const o = e.selection.getNode()
          ...
          , l = ((e,t)=>{
            ...
            return m.from(n.target).isNone() && !1 === N(e) && (n.target = C(e)),
            n.href = ((e,t)=>"http" !== t && "https" !== t || J(e) ? e : t + "://" + e)(n.href, _(e)),
            n
        }
        )(e, (e=>{
        ...
        e.undoManager.transact((()=>{
            ...
            )(e, r, n.text, l)) : ((e,t,n,o)=>{
                te(t) ? se(e, t, o) : n.fold((()=>{
        ...
        return {
            onChange: (e,t)=>{
                ...
                return "url" === r ? (e=>{
                    ...
                    var o;
                    const r = (e=>y(n.title.length <= 0, m.from(e.meta.title).getOr("")))(e.url);
                    return t.isSome() || r.isSome() ? m.some({
                        ...t.map((e=>({
                            text: e
                        }))).getOr({}),
                        ...r.map((e=>({
                ...
                )(e()) : ((e,t)=>d.call(e, t))(["anchor", "link"], r) > -1 ? o(e(), t) : "text" === r || "title" === r ? (n[r] = e()[r],
                m.none()) : m.none()
            }
        }
    }
    ...
    const ge = e=>{
      ...
      , ve = e=>{
        const t = N(e);
        return l(t) ? B(t).orThunk((()=>m.some(ke))) : !1 === t ? m.none() : m.some(ke)
    }
      , ye = (e,t,n)=>{
      ...
      , xe = (e,t)=>(e=>{
        ...
        return new Promise((e=>{
            o(n) ? fetch(n).then((e=>e.ok ? e.text().then(pe) : Promise.reject())).then(e, (()=>e(m.none()))) : i(n) ? n((t=>e(m.some(t)))) : e(m.from(n))
        }
        )).then((e=>e.bind(I(t)).map((e=>e.length > 0 ? [{
            text: "None",
            value: ""
        }].concat(e) : e))))
    }
      ...
      , _e = e=>{
        ...
        t.then((t=>{
            const n = ((e,t)=>n=>{
                ...
                ((e,t)=>f([ge, me(_(e), O(e))], (e=>e(t))).fold((()=>Promise.resolve(t)), (n=>new Promise((o=>{
                    ((e,t,n)=>{
    ...
    const we = (e,t)=>e.dom.getParent(t, "a[href]")
      ...
      , Te = (e,t)=>(e.on("NodeChange", t),
    ()=>e.off("NodeChange", t))
      , Se = e=>t=>{
        const n = ()=>t.setActive(!e.mode.isReadOnly() && null !== X(e, e.selection.getNode()));
        return n(),
        Te(e, n)
    }
      , Ee = e=>t=>{
      ...
      , Pe = e=>t=>{
        const n = t=>{
            return Z(t) || (n = e.selection.getRng(),
            H(n, G).length > 0);
            var n
        }
          , o = e.dom.getParents(e.selection.getStart());
        return t.setEnabled(n(o)),
        Te(e, (e=>t.setEnabled(n(e.parents))))
    }
    ;
    e.add("link", (e=>{
        (e=>{
        ...
        (e=>{
            e.ui.registry.addContextMenu("link", {
                update: t=>Z(e.dom.getParents(t, "a")) ? "link unlink openlink" : "link"
            })
        }
        )(e),
        (e=>{
            const t = t=>{
                ...
                return t.setEnabled(null !== X(e, n)),
                u
            }
            ;
        ...
        (e=>{
            e.on("click", (t=>{
                ...
                n && be.metaKeyPressed(t) && (t.preventDefault(),
                Oe(e, n))
            }
            )),
            e.on("keydown", (t=>{
