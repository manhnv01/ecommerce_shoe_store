...
!function() {
    ...
    const S = O.DOM
      ...
      , C = (e,t)=>{
        ...
        return r.source = r.source || r.src || r.data,
    ...
    const F = (e,t={})=>A({
      ...
      , B = (e,t)=>{
        const r = k.extend({}, t);
        if (!r.source && (k.extend(r, C(r.embed, e.schema)),
        !r.source))
            return "";
        r.altsource || (r.altsource = ""),
        r.poster || (r.poster = ""),
            ...
            return E(r.embed, r, !0, e.schema);
        {
            ...
            )(r, o) : "application/x-shockwave-flash" === r.sourcemime ? (e=>{
      ...
      , K = (e,t)=>{
        const r = t ? ((e,t)=>d(t, e).bind((e=>d(e, "meta"))))(t, e).getOr({}) : {}
          , o = ((e,t,r)=>o=>{
            ...
            return {
                [o]: (o === r ? s().bind((e=>a(e) ? n(e).orThunk(c) : c().orThunk((()=>i.from(e))))) : c().orThunk((()=>s().bind((e=>a(e) ? n(e) : i.from(e)))))).getOr("")
            }
        }
        )(e, r, t);
        return {
          ...
          , u = e.windowManager.open({
            ...
            onSubmit: t=>{
                ...
                ((e,t,r)=>{
                    ...
                    h(W, a))) ? Y(r, t.embed) : H(r, t).then((e=>{
                        Y(r, e.html)
                    }
                    )).catch(V(r))
                }
    ...
    const te = e=>{
      ...
      , ie = (e,t,r)=>{
        ...
        for (; o--; ) {
            const t = a[o].name;
            let c = a[o].value;
            "width" === t || "height" === t || "style" === t || (i = "data-mce-",
            (s = t).length >= i.length && s.substr(0, 0 + i.length) === i) || ("data" !== t && "src" !== t || (c = e.convertURL(c, t)),
      ...
      , ne = e=>{
        for (; e = e.parent; )
            if (e.attr("data-ephox-embed-iri") || ce(e))
                return !0;
        return !1
    }
      , le = (e,t,r)=>{
    ...
    (e=>{
        e.on("PreInit", (()=>{
            ...
            a.addNodeFilter("iframe,video,audio,object,embed,script", (e=>t=>{
                ...
                for (; a--; )
                    r = t[a],
                    r.parent && (r.parent.attr("data-mce-object") || (te(r) && y(e) ? ne(r) || r.replace(se(e, r)) : ne(r) || r.replace(oe(e, r))))
            }
            )(e)),
            r.addAttributeFilter("data-mce-object", ((t,r)=>{
                ...
                for (; a--; ) {
                    ...
                    if ("audio" !== s && "script" !== s) {
                        ...
                        e && -1 !== e.indexOf("mce-preview-object") ? i.attr({
