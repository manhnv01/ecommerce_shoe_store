...
!function() {
    ...
    n)
      ...
      , E = (e,t,n)=>e.isSome() && t.isSome() ? p.some(n(e.getOrDie(), t.getOrDie())) : p.none()
      , I = e=>{
        if (null == e)
    ...
    const _ = e=>t=>$(t) && U(t) === e
      ...
      , Q = (e,t,n)=>((e,t,n,r,o)=>r(n) ? p.some(n) : a(o) && o(n) ? p.none() : t(n, r, o))(0, z, e, t, n)
      , q = (e,t)=>{
        H(e).each((n=>{
    ...
    const te = Object.keys
      ...
      , oe = e=>N(e.dom.attributes, ((e,t)=>(e[t.name] = t.value,
    e)), {})
    ...
    const de = e=>t=>t && t.nodeName.toLowerCase() === e
      ...
      , Ae = (e,t)=>{
        ...
        let a, l, d;
        for (l = n.create(s, i),
        be(t.firstChild, r) || o.appendChild(l); a = t.firstChild; ) {
            const e = a.nodeName;
            d || "SPAN" === e && "bookmark" === a.getAttribute("data-mce-type") || (d = !0),
            be(a, r) ? (o.appendChild(a),
            l = null) : (l || (l = n.create(s, i),
            o.appendChild(l)),
            l.appendChild(a))
        }
      ...
      , Ee = (e,t,n)=>{
        b(n, "Indent" === t ? xe : t=>((e,t)=>{
            De(t) ? ie(t, "dt") : Be(t) && H(t).each((n=>((e,t,n)=>{
                const r = we.select('span[data-mce-type="bookmark"]', t)
                  , o = Ae(e, n)
                  , s = we.createRng();
                s.setStartAfter(n),
                s.setEndAfter(t);
                ...
                we.insertAfter(o, t),
                Se(e.dom, n.parentNode) && (a = n.parentNode,
                le.each(r, (e=>{
      ...
      , $e = e=>{
        ...
        return S(((e,t)=>{
            const n = le.map(t, (t=>e.dom.getParent(t, "li,dd,dt", He(e, t)) || t));
            return B(n)
        }
        )(e, t), he)
    }
      ...
      , He = (e,t)=>{
        const n = e.dom.getParents(t, e.dom.isBlock)
          , r = O(n, (t=>{
            return n = e.schema,
            !me(r = t) && !he(r) && C(Pe, (e=>n.isValidChild(r.nodeName, e)));
            var n, r
        }
        ));
      ...
      , Ke = (e,t,n)=>e.dispatch("ListMutation", {
        action: t,
        element: n
    })
      , Ve = (ze = /^\s+|\s+$/g,
      ...
      , et = e=>(b(e, ((t,n)=>{
        ((e,t)=>{
            const n = e[t].depth
              ...
              , o = e=>e.depth < n;
            return L(k(e.slice(0, t)), r, o).orThunk((()=>L(e.slice(t + 1), r, o)))
        }
        )(e, n).fold((()=>{
            t.dirty && (e=>{
    ...
    e)
      , tt = (e,t,n,r)=>K(r).filter(Ze).fold((()=>{
        t.each((e=>{
            R(e.start, r) && n.set(!0)
        }
        ));
        const o = ((e,t,n)=>H(e).filter($).map((r=>({
            depth: t,
            dirty: !1,
            isSelected: n,
            content: Ye(e),
        ...
        const s = V(r).filter(Ze).map((r=>nt(e, t, n, r))).getOr([]);
      ...
      , rt = (e,t)=>{
        const n = et(t);
        return ((e,t)=>{
            const n = N(t, ((t,n)=>n.depth > t.length ? ((e,t,n)=>{
                const r = ((e,t,n)=>{
                    const r = [];
                    for (let o = 0; o < n; o++)
                ...
                return D(r).each((t=>{
                    ...
                    ((e,t)=>{
                        U(e.list) !== t.listType && (e.list = ie(e.list, t.listType)),
                        re(e.list, t.listAttributes)
                    }
                    )(t, n)
                }
      ...
      , ot = (e,t,n)=>{
        ...
        b(r, (t=>{
            ...
            )(t, Je), (t=>w(t).exists(Je) ? rt(e, t) : ((e,t)=>{
                const n = et(t);
                return v(n, (t=>{
                    const n = ((e,t)=>{
    ...
    const ct = ae.DOM
      , ut = e=>{
        const t = {}
          , n = n=>{
            ...
            if (1 === r.nodeType) {
                const e = ct.create("span", {
                    "data-mce-type": "bookmark"
                });
                r.hasChildNodes() ? (o = Math.min(o, r.childNodes.length - 1),
                n ? r.insertBefore(e, r.childNodes[o]) : ct.insertAfter(e, r.childNodes[o])) : r.appendChild(e),
                r = e,
                o = 0
            }
      ...
      , mt = e=>{
        const t = t=>{
            let n, r = n = e[t ? "startContainer" : "endContainer"], o = e[t ? "startOffset" : "endOffset"];
            r && (1 === r.nodeType && (o = (e=>{
            ...
            r = r.parentNode,
            ct.remove(n),
            !r.hasChildNodes() && ct.isBlock(r) && r.appendChild(ct.create("br"))),
      ...
      , ht = (e,t,n)=>{
        const r = e=>{
            const r = L(e.parents, me, ye).filter((e=>e.nodeName === t && !gt(e))).isSome();
            n(r)
        }
      ...
      , Ct = (e,t,n,r)=>{
        ...
        for (1 === o.nodeType && (o = o.childNodes[Math.min(s, o.childNodes.length - 1)] || o),
        !n && Ce(o.nextSibling) && (o = o.nextSibling); o.parentNode !== r; ) {
            if (ve(e, o))
                return o;
      ...
      , vt = (e,t,n)=>{
          ...
          , l = ((e,t,n)=>{
            ...
            return le.each(l, (t=>{
                if (ve(e, t))
                    ...
                    void (a = null);
                if (o.isBlock(t) || Ce(t))
                    return Ce(t) && o.remove(t),
                    void (a = null);
                const s = t.nextSibling;
                dt.isBookmarkNode(t) && (me(s) || ve(e, s) || !s && t.parentNode === n) ? a = null : (a || (a = o.create("p"),
        ...
        le.each(l, (r=>{
            ...
            const a = r.previousSibling
              , l = r.parentNode;
            he(l) || (a && me(a) && a.nodeName === t && ((e,t,n)=>{
            ...
            r = i.rename(r, o),
            a.appendChild(r)) : (s = i.create(t),
            r.parentNode.insertBefore(s, r),
            s.appendChild(r),
            r = i.rename(r, o)),
            ((e,t,n)=>{
                le.each(["margin", "margin-right", "margin-bottom", "margin-left", "margin-top", "padding", "padding-right", "padding-bottom", "padding-left", "padding-top"], (n=>e.setStyle(t, n, "")))
            }
            )(i, r),
            yt(i, s, n),
            St(e.dom, s))
      ...
      , bt = (e,t,n)=>{
        return ((e,t)=>e && t && me(e) && e.nodeName === t.nodeName)(t, n) && ((e,t,n)=>e.getStyle(t, "list-style-type", !0) === e.getStyle(n, "list-style-type", !0))(e, t, n) && (r = n,
      ...
      , Lt = (e,t,n)=>{
        const r = Ue(e)
          , s = (e=>{
            ...
            return ((e,t)=>e && 1 === t.length && t[0] === e)(t, n) ? (e=>S(e.querySelectorAll(Re), me))(t) : S(n, (e=>me(e) && t !== e))
        }
        )(e)
          , i = o(n) ? n : {};
        s.length > 0 ? ((e,t,n,r,o)=>{
            const s = me(t);
            if (s && t.nodeName === r && !Nt(o))
                lt(e);
            else {
                vt(e, r, o);
        ...
        le.each(n, (t=>{
            ((e,t)=>{
                ...
                if ("LI" === n.nodeName && n.firstChild === t) {
                    ...
                    Se(e, n) && Ot.remove(n)) : Ot.setStyle(n, "listStyleType", "none")
                }
                if (me(n)) {
      ...
      , kt = (e,t,n,r)=>{
        ...
        if (ue(o) && (n ? s < o.data.length : s > 0))
            return o;
        const i = e.schema.getNonEmptyElements();
        1 === o.nodeType && (o = X.getNode(o, s));
        const a = new Y(o,r);
        n && ((e,t)=>!!Ce(t) && e.isBlock(t.nextSibling) && !Ce(t.previousSibling))(e.dom, o) && a.next();
      ...
      , wt = (e,t,n)=>{
        ...
        o === n.lastChild && Ce(o.previousSibling) && e.remove(o.previousSibling);
        const s = n.lastChild;
                ...
                return e.undoManager.transact((()=>{
                    ...
                    t ? ((e,t,n,r)=>{
                        ...
                        if (o.isEmpty(r))
                            ...
                            const s = ut(t);
                            wt(o, n, r),
                            e.selection.setRng(mt(s))
                        }
                    }
                    )(e, a, l, i) : (n = i).parentNode.firstChild === n ? at(e) : ((e,t,n,r)=>{
                        const o = ut(t);
                        wt(e.dom, n, r);
                        const s = mt(o);
      ...
      , xt = (e,t)=>e.selection.isCollapsed() ? ((e,t)=>Dt(e, t) || ((e,t)=>{
        const n = e.dom
        ...
        if (s && n.isEmpty(s)) {
            ...
            if (i) {
                const a = e=>y(["td", "th", "caption"], U(e))
                  , l = e=>e.dom === o;
                return !!((e,t,n=c)=>E(e, t, n).getOr(e.isNone() && t.isNone()))(Q(P(i), a, l), Q(P(r.startContainer), a, l), R) && (e.undoManager.transact((()=>{
                    ((e,t,n)=>{
    ...
    )(e, t))(e, t) : (e=>!!Bt(e) && (e.undoManager.transact((()=>{
    ...
    !1 === e.hasPlugin("rtc", !0) ? ((e=>{
        Oe(e) && (e=>{
            e.on("keydown", (t=>{
                t.keyCode !== ee.TAB || ee.metaKeyPressed(t) || e.undoManager.transact((()=>{
        ...
        e.addCommand("mceListUpdate", ((t,n)=>{
            o(n) && ((e,t)=>{
                ...
                e.undoManager.transact((()=>{
                    ...
                    o(t.attrs) && ne(t.attrs, ((t,r)=>e.dom.setAttrib(n, r, t)))
                }
                ))
            }
            )(e, n)
