...
!function() {
    ...
    const V = e=>e.dom.nodeName.toLowerCase()
      ...
      , ne = c(Element.prototype.attachShadow) && c(Node.prototype.getRootNode) ? e=>j.fromDom(e.dom.getRootNode()) : ee
      ...
      , ae = e=>{
        ...
        )(j.fromDom(t)).fold((()=>o.body.contains(t)), (l = ae,
        n = re,
        e=>l(n(e))));
        var l, n
    }
      ...
      , ue = (e,t)=>((e,o)=>B(e.dom.childNodes, (e=>{
        return o = j.fromDom(e),
        Q(o, t);
        var o
    }
    )).map(j.fromDom))(e)
      ...
      , be = (e,t,o)=>((e,t,o,l,n)=>((e,t)=>Q(e, t))(o, l) ? f.some(o) : c(n) && n(o) ? f.none() : t(o, l, n))(0, de, e, t, o)
      , ge = (e,t,o)=>{
        if (!(l(o) || r(o) || i(o)))
    ...
    const xe = e=>e.length > 0
      ...
      , De = (e,t,o=0)=>fe(e, t).map((e=>parseInt(e, 10))).getOr(o)
      , Ie = (e,t)=>Me(e, t, h)
      ...
      , Le = e=>fe(e, "data-snooker-locked-cols").bind((e=>f.from(e.match(/\d+/g)))).map((e=>((e,t)=>{
        const o = {};
        for (let l = 0, n = e.length; l < n; l++) {
            const n = e[l];
            o[String(n)] = t(n, l)
      ...
      , je = e=>{
        ...
        var l;
        const n = (l = e,
        q(l, 0)).map((e=>e.element)).bind(Be).bind(Le).getOr({});
        let r = 0
          , a = 0
          , s = 0;
        ...
        const {columns: m, colgroups: d} = (e=>q(e, e.length - 1))(c).map((e=>{
            const t = (e=>{
                const t = {};
                let o = 0;
                return N(e.cells, (e=>{
    ...
    const Ge = (e,t,o)=>((t,l)=>{
      ...
      , Xe = e=>((e,t)=>{
        ...
        return "border-box" === t ? l : ((e,t,o,l)=>t - Qe(e, "padding-left", 0) - Qe(e, "padding-right", 0) - Qe(e, "border-left-width", 0) - Qe(e, "border-right-width", 0))(e, l)
    }
    )(e, "content-box");
    ...
    const Ze = I(5, (e=>{
      ...
      , et = M(["Solid", "Dotted", "Dashed", "Double", "Groove", "Ridge", "Inset", "Outset", "None", "Hidden"], (e=>({
        title: e,
        value: e.toLowerCase()
    })))
      , tt = "100%"
      ...
      , Ct = e=>{
        ...
        return t.isSet("table_default_styles") ? o : ((e,t)=>St(e) || !ut(e) ? t : wt(e) ? {
            ...t,
            width: ot(e)
        } : {
            ...t,
      ...
      , vt = e=>{
        ...
        return t.isSet("table_default_attributes") ? o : ((e,t)=>St(e) || ut(e) ? t : wt(e) ? {
            ...t,
            width: ot(e)
        } : {
            ...t,
      ...
      , Rt = (e,t)=>t.column >= e.startCol && t.column + t.colspan - 1 <= e.finishCol && t.row >= e.startRow && t.row + t.rowspan - 1 <= e.finishRow
      , _t = (e,t,o)=>((e,t,o)=>{
        const l = We(e, t, Y)
          , n = We(e, o, Y);
    ...
    const Et = (e,t,o,l)=>{
      ...
      , qt = {
        ...
        attrs: d({
            ...
            copyTo: (e,t)=>{
                ...
                )(t, k(e.dom.attributes, ((e,t)=>(e[t.name] = t.value,
                e)), {}))
            }
        }),
        insert: d({
      ...
      , Lt = e=>de(e, "table")
      , Ht = (e,t,o)=>pe(e, t).bind((t=>pe(e, o).bind((e=>{
        return (o = Lt,
        l = [t, e],
        ((e,t,o)=>o.length > 0 ? ((e,t,o,l)=>l(e, t, o[0], o.slice(1)))(e, t, o, Et) : f.none())(qt, ((e,t)=>o(t)), l)).map((o=>({
            first: t,
            last: e,
            table: o
        })));
      ...
      , zt = e=>(t,o)=>{
        const l = V(t)
          , n = "col" === l || "colgroup" === l ? Be(r = t).bind((e=>((e,t)=>((e,t)=>{
            const o = ie(e, t);
            return o.length > 0 ? f.some(o) : f.none()
        }
        )(e, t))(e, Vt.firstSelectedSelector))).fold(d(r), (e=>e[0])) : t;
        var r;
        return be(n, e, o)
    }
      , Wt = zt("th,td,caption")
      ...
      , Gt = (e,t)=>{
        ...
        return Se(o, l, ((e,o)=>P(o, (o=>D(jt(o.dom.cells), (o=>"1" === he(o, t) || Y(o, e))))))).getOr([])
    }
      , Kt = [{
        text: "None",
        value: ""
      ...
      , no = e=>{
        if ("transparent" === e)
            return f.some(oo(0, 0, 0, 0));
        const t = eo.exec(e);
        if (null !== t)
            return f.some(lo(t[1], t[2], t[3], "1"));
        const o = to.exec(e);
      ...
      , ao = (e,t,o)=>l=>{
        const n = (e=>{
          ...
          , a = ()=>{
            ...
            r ? (l.setActive(!D(a, s)),
            n.set(e.formatter.formatChanged(t, (e=>l.setActive(!e)), !0))) : (l.setActive(F(a, s)),
      ...
      , bo = (e,t,o)=>{
        const l = M(t, (e=>{
            return {
                ...
                value: "#" + (o = e.value,
                (t = o,
                (e=>Jt.test(e) || Qt.test(e))(t) ? f.some({
                    value: Xt(t)
                }) : f.none()).orThunk((()=>no(o).map(Zt))).getOrThunk((()=>{
      ...
      , Ao = (e,t,o)=>{
        const l = (e=>{
            ...
            return (l = t,
            ((e,t,o=g)=>o(t) ? f.none() : O(e, V(t)) ? f.some(t) : de(t, e.join(","), (e=>Q(e, "table") || o(e))))(["td", "th"], l, n)).bind((t=>xo(e, t))).filter(o);
            var l, n
        }
        )));
        return n = l,
        l.length > 0 ? f.some(n) : f.none();
        var n
    }
      , Ro = (e,t)=>Ao(e, t, h)
      , _o = (e,t)=>F(t, (t=>((e,t)=>xo(e, t).exists((e=>!e.isLocked)))(e, t)))
    ...
    (e,t)=>{
      ...
      , Mo = e=>{
        return Ce(e, "rgb") ? no(t = e).map(Zt).map((e=>"#" + e.value)).getOr(t) : e;
        var t
    }
      , No = e=>{
        const t = j.fromDom(e);
      ...
      , ko = (e,t,o,l)=>B(e, (e=>!a(o.formatter.matchNode(l, t + e)))).getOr("")
      , Bo = b(ko, ["left", "center", "right"], "align")
      , Eo = b(ko, ["top", "middle", "bottom"], "valign")
      , Fo = e=>Be(j.fromDom(e)).map((t=>{
        const o = {
      ...
      , Lo = (e,t,o,l)=>{
        ...
        e.undoManager.transact((()=>{
            ((e,t,o,l)=>{
                ...
                v(n) > 0 && t.length >= 1 && Be(t[0]).each((o=>{
                    const r = qo(o, t)
                    ...
                    (a || x(n, "scope")) && ((e,t,o,l)=>{
                        ...
                        N(t, (t=>{
                            ...
                            st(e) && ((e,t,o)=>{
                                ...
                                o("borderwidth") && e.setFormat("tablecellborderwidth", xt(t.borderwidth))
                            }
                            )(s, o, a),
      ...
      , Ho = e=>{
        ...
        if (0 === t.length)
            return;
        const o = ((e,t)=>{
            const o = Be(t[0]).map((o=>M(qo(o, t), (t=>((e,t,o,l)=>{
                const n = e.dom
        ...
        e.undoManager.transact((()=>{
            ((e,t,o,l)=>{
                ...
                if (v(n) > 0) {
                    ...
                    Be(j.fromDom(t[0])).each((t=>Je(e, t.dom, {
                        structure: o,
                        style: r
                    })))
                }
      ...
      , Go = (e,t,o,l)=>{
        ...
        e.undoManager.transact((()=>{
            if (!t) {
                ...
                t = $t(At(e), Tt(e)).bind((t=>Be(t, Tt(e)))).map((e=>e.dom)).getOrUndefined()
            }
            if (v(a) > 0) {
                ((e,t,o)=>{
                    const l = e.dom
                    ...
                    ut(e) ? r.width = xt(o.width) : l.getAttrib(t, "width") && (n.width = (e=>e ? e.replace(/px$/, "") : "")(o.width)),
                    ut(e) ? (r["border-width"] = xt(o.border),
                    r["border-spacing"] = xt(o.cellspacing)) : (n.border = o.border,
                    ...
                    ut(e) && t.children)
                        for (let n = 0; n < t.children.length; n++)
                            ...
                            it(e) && Uo(l, t.children[n], {
                                "border-color": o.bordercolor
                            });
                    it(e) && (r["background-color"] = o.backgroundcolor,
      ...
      , Ko = (e,t)=>{
        ...
        let l, n = ((e,t)=>{
            ...
            return {
                ...
                ...{
                    ...T(o, "border-spacing").or(T(l, "cellspacing")).fold((()=>({})), (e=>({
                        cellspacing: e
                    }))),
                    ...T(o, "border-padding").or(T(l, "cellpadding")).fold((()=>({})), (e=>({
                        cellpadding: e
                    })))
                }
            }
        ...
        !1 === t ? (l = o.getParent(e.selection.getStart(), "table", e.getBody()),
        l ? n = ((e,t,o)=>{
            const l = e.dom
        ...
        )(e, l, it(e)) : it(e) && (n.borderstyle = "",
        n.bordercolor = "",
        n.backgroundcolor = "")) : (n.cols = "1",
        n.rows = "1",
        it(e) && (n.borderstyle = "",
        n.bordercolor = "",
        n.backgroundcolor = ""));
      ...
      , Xo = (e,t,o)=>{
        ...
        Ht(l, n, r).bind((e=>{
            const t = e=>Y(l, e)
              ...
              , n = de(e.first, o, t)
              , r = de(e.last, o, t);
            return n.bind((t=>r.bind((o=>Y(t, o) ? ((e,t,o)=>{
                const l = Ot(e);
                return _t(l, t, o)
            }
      ...
      , Yo = e=>{
        ...
        const n = J("caption")
          , r = e=>l.forall((t=>!t[e]))
          , a = ()=>Wt(At(e), Tt(e)).bind((t=>{
            return o = Se(Be(t), Wt((e=>j.fromDom(e.selection.getEnd()))(e), Tt(e)).bind(Be), ((o,l)=>Y(o, l) ? n(t) ? f.some((e=>({
                element: e,
                mergable: f.none(),
                unmergable: f.none(),
                selection: [e]
          ...
          , s = e=>Be(e.element).map((t=>{
            const o = Ve(t)
              , l = Ro(o, e).getOr([])
              , n = k(l, ((e,t)=>(t.isLocked && (e.onAny = !0,
        ...
        return e.on("NodeChange ExecCommand TableSelectorChange", c),
        {
            ...
            resetTargets: c,
            onSetupTableWithCaption: t=>d(t, g, (t=>Be(t.element, Tt(e)).exists((e=>ue(e, "caption").isSome())))),
    ...
    e.add("table", (e=>{
        ...
        ((e,t)=>{
            ...
            e.ui.registry.addContextMenu("table", {
                ...
                t.targets().fold(d(""), (e=>"caption" === V(e.element) ? "tableprops deletetable" : "cell row column | advtablesort | tableprops deletetable")))
            });
            const m = uo(gt(e));
            0 !== m.length && e.queryCommandSupported("mceTableToggleClass") && e.ui.registry.addNestedMenuItem("tableclass", {
                icon: "table-classes",
                text: "Table styles",
                getSubmenuItems: ()=>io(e, m, "tableclass", (t=>e.execCommand("mceTableToggleClass", !1, t))),
                onSetup: t.onSetupTable
            });
            const u = uo(pt(e));
            0 !== u.length && e.queryCommandSupported("mceTableCellToggleClass") && e.ui.registry.addNestedMenuItem("tablecellclass", {
                ...
                text: "Cell styles",
                getSubmenuItems: ()=>io(e, u, "tablecellclass", (t=>e.execCommand("mceTableCellToggleClass", !1, t))),
                onSetup: t.onSetupCellOrRow
            }),
            e.queryCommandSupported("mceTableApplyCellStyle") && (e.ui.registry.addNestedMenuItem("tablecellvalign", {
                icon: "vertical-align",
                text: "Vertical align",
                getSubmenuItems: ()=>io(e, Kt, "tablecellverticalalign", mo(e, "vertical-align")),
                onSetup: t.onSetupCellOrRow
            }),
            e.ui.registry.addNestedMenuItem("tablecellborderwidth", {
                icon: "border-width",
                text: "Border width",
                getSubmenuItems: ()=>io(e, rt(e), "tablecellborderwidth", mo(e, "border-width")),
                onSetup: t.onSetupCellOrRow
            }),
            e.ui.registry.addNestedMenuItem("tablecellborderstyle", {
                icon: "border-style",
                text: "Border style",
                getSubmenuItems: ()=>io(e, at(e), "tablecellborderstyle", mo(e, "border-style")),
                onSetup: t.onSetupCellOrRow
            }),
        ...
        ((e,t)=>{
            ...
            0 !== r.length && e.queryCommandSupported("mceTableToggleClass") && e.ui.registry.addMenuButton("tableclass", {
                ...
                fetch: po(e, r, "tableclass", (t=>e.execCommand("mceTableToggleClass", !1, t))),
                onSetup: t.onSetupTable
            });
            const a = uo(pt(e));
            0 !== a.length && e.queryCommandSupported("mceTableCellToggleClass") && e.ui.registry.addMenuButton("tablecellclass", {
                icon: "table-cell-classes",
                tooltip: "Cell styles",
                fetch: po(e, a, "tablecellclass", (t=>e.execCommand("mceTableCellToggleClass", !1, t))),
                onSetup: t.onSetupCellOrRow
            }),
